...
'''
python3 MOT_train_17_small_learning_rate.py 
--train_txt ./MOT17_database/train_path.txt --train_info ./MOT17_database/train_info.npy  --batch_size 32 --test_txt ./MOT_database/test_path.txt  --test_info  ./MOT_database/test_info.npy   --query_info ./MARS_database/query_IDX.npy --n_epochs 20000 --lr 0.00005 --lr_step_size 5 --optimizer adam --ckpt ckpt_NL_0230 --log_path loss.txt --class_per_batch 1 --model_type resnet50_NL --num_workers 8 --track_per_class 4 --S 8 --latent_dim 2048 --temporal Done  --track_id_loss --non_layers  0 2 3 0
小的学习率和小的步长
...
if __name__ == '__main__':
    ...
    modelPath = './ckpt/Similarity_MOT17_small_learning_rate.pth'
    ...
    for e in range(args.n_epochs):
        ...
        print('%.4f' % total_loss)
        modelCheckpoint = os.path.join('ckpt', 'Similarity_MOT17_small_learning_rate_.pth')
