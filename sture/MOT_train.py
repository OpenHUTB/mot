...
--train_txt ./MOT_database/train_path.txt --train_info ./MOT_database/train_info.npy  --batch_size 32 --test_txt ./MOT_database/test_path.txt  --test_info  ./MOT_database/test_info.npy   --query_info ./MARS_database/query_IDX.npy --n_epochs 20000 --lr 0.0005 --lr_step_size 50 --optimizer adam --ckpt ckpt_NL_0230 --log_path loss.txt --class_per_batch 1 --model_type resnet50_NL --num_workers 8 --track_per_class 4 --S 8 --latent_dim 2048 --temporal Done  --track_id_loss --non_layers  0 2 3 0
...
if __name__ == '__main__':
    ...
    train_dataloader = utils.Get_MOT_train_DataLoader(args.train_txt, args.train_info, train_transform, shuffle=True,
    ...
    for e in range(args.n_epochs):
        ...
        print('%.4f' % total_loss)
        modelCheckpoint = os.path.join('ckpt', 'Similarity_.pth')
