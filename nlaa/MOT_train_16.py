...
'''
python3 MOT_train.py 
小的学习率和小的步长
--train_txt ./MOT16_database/train_path.txt --train_info ./MOT16_database/train_info.npy  --batch_size 32 --test_txt ./MOT_database/test_path.txt  --test_info  ./MOT_database/test_info.npy   --query_info ./MARS_database/query_IDX.npy --n_epochs 800 --lr 0.00001 --lr_step_size 2 --optimizer adam --ckpt ckpt_NL_0230 --log_path loss.txt --class_per_batch 1 --model_type resnet50_NL --num_workers 8 --track_per_class 4 --S 8 --latent_dim 2048 --temporal Done  --track_id_loss --non_layers  0 2 3 0
大的学习率0.0005
--train_txt ./MOT16_database/train_path.txt --train_info ./MOT16_database/train_info.npy  --batch_size 32 --test_txt ./MOT_database/test_path.txt  --test_info  ./MOT_database/test_info.npy   --query_info ./MARS_database/query_IDX.npy --n_epochs 20000 --lr 0.0005 --lr_step_size 50 --optimizer adam --ckpt ckpt_NL_0230 --log_path loss.txt --class_per_batch 1 --model_type resnet50_NL --num_workers 8 --track_per_class 4 --S 8 --latent_dim 2048 --temporal Done  --track_id_loss --non_layers  0 2 3 0
...
if __name__ == '__main__':
    ...
    # test_dataloader = utils.Get_MOT_test_DataLoader(args.test_txt, args.test_info, args.query_info, test_transform,
    #                                                   batch_size=args.batch_size, \
    #                                                   shuffle=False, num_workers=args.num_workers, S=args.S,
    #                                                   distractor=True)
    ...
    modelPath = './ckpt/Similarity_MOT16.pth'
    ...
    for e in range(args.n_epochs):
        print('epoch', e)
        # if e == 0:
        # if (e + 1) % 2 == 0:  # execute validation and record log every 10 epochs
        ...
        print('%.4f' % total_loss)
        if e % 5 == 0:
            modelCheckpoint = os.path.join('ckpt', 'Similarity_MOT16_%d.pth' % e)
