...
current_select_configure = 'init_train_mot17' # init_train_mot17,   init_test_mot17

config = {
    'mot_root': r'/home/ssm/ssj/dataset/MOT17',
    'save_folder': '/home/ssm/ssj/weights/MOT17/weights0326-I50k-M80-G30',
    'log_folder': '/data2/whd/workspace/MOT/SST/results/log_folder',
    'base_net_folder': '/home/ssm/ssj/weights/MOT17/vgg16_reducedfc.pth',
    'resume': '/data2/whd/workspace/MOT/SST/weights/sst300_0712_83000.pth',
    'start_iter': 55050,
    'cuda': True,
    'batch_size': 8,
    'num_workers': 16,
    ...
    'sst_dim': 900,
    'sst_dim_width': 1088,  # the width of DAL network input
    'sst_dim_height': 608,  # the height of DAL network input
    'sst_input_size': (1088, 608),
    'min_visibility': 0.3,
...
def init_test_mot17():
    ...
    config['mot_root'] = '/data2/whd/workspace/MOT/FairMOT/src/data/MOT17/images/'
    config['save_folder'] = '/data2/whd/workspace/MOT/FairMOT/SST/results/save_folder'
    config['log_folder'] = '/data2/whd/workspace/MOT/SST/results/log_folder'
    config['batch_size'] = 1
...
def init_train_mot17():
    ...
    config['log_folder'] = '/data2/whd/workspace/MOT/SST/results/log_folder/train/'
    config['save_folder'] = '/data2/whd/workspace/MOT/FairMOT/SST/results/train/save_folder/1031-E120-M80-G30-weights'
    config['save_images_folder'] = '/data2/whd/workspace/MOT/FairMOT/SST/results/train/save_images_folder/1031-E120-M80-G30-images'
    config['type'] = 'train'
    config['resume'] = './weights/sst300_0712_83000.pth'  # None means training from sketch.
    config['detector'] = 'SDP'
    config['start_iter'] = 0
    ...
    config['cuda'] = True
    config['max_object'] = 150  # 80->150,  MOT17-03-FRCNN.txt:700, 46, 0_0_4_0_3_3:   RuntimeError: invalid argument 0: Sizes of tensors must match except in dimension 1. Got 80 and 95 in dimension 2
...
def init_train_ua():
    ...
    config['resume'] = '/data2/whd/workspace/MOT/SST/weights/sst300_0712_83000.pth'
