...
class YOLO(object):
    def __init__(self):
        ...
        self.model_image_size = (608, 608) # (416, 416)  # fixed size or (None, None)
    ...
    def detect_image(self, image):
        ...
        if self.is_fixed_size:
            ...
            boxed_image = letterbox_image(image, tuple(reversed(self.model_image_size))) # 将图像调整为模型需要的大小 416*416
        else:
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            if predicted_class != 'person' and predicted_class != 'car':  # predicted_class != 'person':
                continue
            box = out_boxes[i]
            score = out_scores[i]
            x = int(box[1])
